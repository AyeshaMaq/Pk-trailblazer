...
global BB BI invI I m mu nextMagUpdate lastMagUpdate lastSensorUpdate maxSpeed
...
if t >= lastMagUpdate
    ...
    latitude = 90 - rad2deg(thetaE); %90-thetaE*180/p;
    longitude = rad2deg(psiE);%*180/pi;
    rhokm = (rho)/1000;
   
    BNED = igrfmagm(rhokm,latitude,longitude,decyear(2020,7,4));
...
H = Is*pqr;
% + Ir1B*w1*n1 + Ir2B*w2*n2 + Ir3B*w3*n3;
